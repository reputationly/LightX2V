...
from lightx2v.models.networks.hunyuan3d.utils import logger, smart_load_model, synchronize_timer

from .attention_blocks import CrossAttentionDecoder, FourierEmbedder, PointCrossAttentionEncoder, Transformer
from .surface_extractors import MCSurfaceExtractor, SurfaceExtractors
from .volume_decoders import FlashVDMVolumeDecoding, HierarchicalVolumeDecoding, VanillaVolumeDecoder
...
class ShapeVAE(VectsetVAE):
    def __init__(
        ...
        *,
        ...
        self.transformer = Transformer(n_ctx=num_latents, width=width, layers=num_decoder_layers, heads=heads, qkv_bias=qkv_bias, qk_norm=qk_norm, drop_path_rate=drop_path_rate)
