...
torchrun --nproc_per_node=4 -m lightx2v.infer \
    ...
    --config_json ${lightx2v_path}/configs/wan_dancer/local_lora_4step.json \
    --seed 0 \
    ...
    --video_path ${lightx2v_path}/save_results/wan_dancer_global_lora_4step_cfg3.mp4 \
    --prompt "$(<${wan_dancer_github_path}/gen_video/prompt/kpop_global.txt)" \
    --save_result_path ${lightx2v_path}/save_results/wan_dancer_final_lora_4step_cfg3.mp4
