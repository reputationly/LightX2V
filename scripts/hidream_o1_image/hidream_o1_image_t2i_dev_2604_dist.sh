...
--config_json ${lightx2v_path}/configs/hidream_o1_image/hidream_o1_image_t2i_dev_2604_dist.json \
...
--save_result_path ${lightx2v_path}/save_results/hidream_o1_image_t2i_dev_2604_dist.png \
--seed 32
