...
--config_json ${lightx2v_path}/configs/seko_talk/npu/seko_talk_04_bf16_dist.json \
...
--save_result_path ${lightx2v_path}/save_results/output_lightx2v_seko_talk_npu_bf16_dist.mp4
