...
--config_json ${lightx2v_path}/configs/seko_talk/npu/seko_talk_03_int8_dist.json \
...
--save_result_path ${lightx2v_path}/save_results/output_lightx2v_seko_talk_int8_dist.mp4
