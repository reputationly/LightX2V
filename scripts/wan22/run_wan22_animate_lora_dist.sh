...
--config_json ${lightx2v_path}/configs/wan22/wan_animate_lora_dist.json \
...
--prompt "视频中的人在做动作" \
--save_result_path ${lightx2v_path}/save_results/output_lightx2v_wan22_animate_lora_dist.mp4
