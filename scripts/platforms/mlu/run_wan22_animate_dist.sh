...
--config_json ${lightx2v_path}/configs/platforms/mlu/wan_animate_dist.json \
...
--save_result_path ${lightx2v_path}/save_results/output_lightx2v_wan22_animate_dist.mp4
